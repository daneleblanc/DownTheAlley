...
//grounded = Physics.Raycast(new Ray(leftFoot.transform.position, -leftFoot.transform.up), groundDistance, noSelfCollision);
//Color color = (!grounded) ? Color.red : Color.green;
//Debug.DrawRay(leftFoot.transform.position, -leftFoot.transform.up * groundDistance, color);